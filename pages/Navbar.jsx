...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <ul className="text-[#8db9e2] md:flex hidden list-none flex-row justify-between items-center flex-initial">
        ...
        <div className="flex relative">
          {toggleMenu
            ? <AiOutlineClose fontSize={28} className="text-[#8db9e2] md:hidden cursor-pointer" onClick={() => setToggleMenu(false)}/> 
            : <HiMenu fontSize={28} className="text-[#8db9e2] md:hidden cursor-pointer" onClick={() => setToggleMenu(true)}/>}
            {toggleMenu && (
              ...
              blue-glassmorphism text-[#8db9e2] animate-slide-in">
              ...
              <Link
                ...
                offset={-200}
                duration={500}
                className="bg-[#1a4b61] py-2 px-7 mx-4  rounded-md cursor-pointer"
              >
                Request an audit
              </Link>
              </ul>
